<template>
  <div class="page">
    <ContentWrap>
      ...
      <el-form class="-mb-15px" :model="queryParams" ref="queryFormRef" :inline="true" label-width="68px">
        ...
        <el-form-item>
          ...
          <el-button type="primary" plain @click="openForm('create')" v-hasPermi="['bpm:model:create']">
      ...
      <el-table v-loading="loading" :data="list">
        ...
        <el-table-column label="操作" align="center" width="240" fixed="right">
          <template #default="scope">
            ...
            <el-button link type="primary" @click="handleSimpleDesign(scope.row.id)" v-hasPermi="['bpm:model:update']">
              仿钉钉设计流程
            </el-button>
    ...
    <Dialog title="流程图" v-model="bpmnDetailVisible" width="800">
      <MyProcessViewer key="designer" v-model="bpmnXML" :value="bpmnXML" v-bind="bpmnControlForm"
...
const getList = async () => {
  loading.value = true
  try {
    const data = await ModelApi.getModelPage(queryParams).then(res => res.data)
    if (!data) return
